  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <div class="span9">
                <a href="AddChan.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Channel Details</a>
                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;Admin Details</strong>
                        </div>
                        <thead>
                            <tr>
                                <th>Id</th>
                        ...
                        <tbody>
                            <?php
                            $query = mysqli_query($conn,"select * from  channel  ") or die(mysqli_error());
