...
<html lang="en">
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
            ...
            <div class="span9">
                <a href="addstaff.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Admin Staff</a>
                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;Admin Staff</strong>
                        </div>
                        <thead>
                            <tr>
                                <th>Admin Id</th>
