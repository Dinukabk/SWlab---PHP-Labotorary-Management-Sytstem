  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	           ...
	           <li>
              <a href="RAppoinment.php">Create Appoinment</a>
              </li>
              <li>
              <a href="Rpayment.php">Take Payment</a>
              </li>
            <li>
              <a href="RVpayment.php">View Payment</a>
            </li>
      ...
      <div id="content" class="p-4 p-md-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="Rhome.php.php">Home</a>
                </li>
                <li class="nav-item">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <div class="span9">
                <a href="Raddapp.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Apoinment Details</a>
                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;Appoinment Details</strong>
                        </div>
                        <thead>
                            <tr>
                                <th>Id</th>
                        ...
                        <tbody>
                            <?php
                            $query = mysqli_query($conn,"select * from apmt ") or die(mysqli_error());
                            ...
                            <div id="id<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="delapp.php<?php echo '?id=' . $id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                </div>
                            </div>
                            <!-- end delete modal -->
