  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <div class="span9">
                <a href="addMed.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Add Medicine Details</a>
                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;Online Channeling Details</strong>
                        </div>
                        <thead>
                            <tr>
                                <th>Id</th>
                        ...
                        <tbody>
                            ...
                            <div id="id<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="DelMed.php<?php echo '?id=' . $id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Delete</a>
                                </div>
                            </div>
                            <!-- end delete modal -->
